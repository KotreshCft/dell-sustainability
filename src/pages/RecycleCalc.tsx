          ...
          <div className="grid grid-cols-2 gap-4 w-full max-w-[57rem]">
            ...
            <div className="py-8 px-12 shadow-2xl" style={{ backgroundColor: "#40586D" }}>
              <div className="text-left flex flex-col justify-start h-full">
                <p className="text-5xl font-bold text-white drop-shadow-lg mb-4">{totalCorrectDisposals}</p>
                <p className="text-[44px] font-light text-white mb-4">Correct disposals</p>
            ...
            <div className="py-8 px-12 shadow-2xl" style={{ backgroundColor: "#40586D" }}>
              <div className="text-left flex flex-col justify-start h-full">
                <p className="text-5xl font-bold text-white drop-shadow-lg mb-4">{plasticRecycled} kg</p>
                <p className="text-[44px] font-light text-white mb-4">Multi layered plastic wastage will be recycled</p>
            ...
            <div className="col-span-2 py-8 px-10 shadow-2xl" style={{ backgroundColor: "#40586D" }}>
              <div className="text-left">
                <p className="text-5xl font-bold text-white drop-shadow-lg mb-8">{formatNumber(chipPacketsLandfilled)}</p>
                <p className="text-[44px] font-light text-white">Chip packets will be diverted from landfills​</p>
                {/* <p className="text-sm text-gray-300 mt-4">
